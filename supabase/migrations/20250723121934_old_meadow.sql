...
-- Insert sample notices (ensure admin user exists first)
INSERT INTO users (id, email, role, phone, name) VALUES 
  ('00000000-0000-0000-0000-000000000001', 'admin@school.edu.bd', 'admin', '+8801700000001', 'System Admin')
